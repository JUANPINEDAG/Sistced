  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h1 class="modal-title text-center" id="myModalLabel">Editar Aula</h1>
      </div>
          ...
          <div class="">
            ...
            <form class="form-horizontal form-label-left" method="POST" action="{{ route('aulas.store') }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    <input class="form-control has-feedback-left" id="inputSuccess2" value="" placeholder="Ubicacion" type="text" name="localizacion">
